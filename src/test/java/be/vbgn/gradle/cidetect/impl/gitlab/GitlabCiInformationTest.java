 ...
 */
public class GitlabCiInformationTest extends AbstractCiInformationTest {
    ...
    protected Map<String, String> getBaseEnv(String buildNumber) {
        ...
        env.put("GITLAB_CI", "");
        env.put("CI_SERVER", "");
        env.put("CI_PIPELINE_IID", buildNumber);
        return env;
    }

    @Override
    protected Map<String, String> getBranchBuildEnv(String branch) {
        return Collections.singletonMap("CI_COMMIT_REF_NAME", branch);
    }

    @Override
    protected Map<String, String> getPullRequestBuildEnv(String sourceBranch, String targetBranch, String prNumber) {
        Map<String, String> env = new HashMap<>();
        env.put("CI_MERGE_REQUEST_SOURCE_BRANCH_NAME", sourceBranch);
        env.put("CI_MERGE_REQUEST_TARGET_BRANCH_NAME", targetBranch);
        env.put("CI_MERGE_REQUEST_IID", prNumber);
        return env;
    }
